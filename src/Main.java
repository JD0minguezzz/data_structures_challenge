...
public class Main {
    ...
    */
    ...
    public static String printNormalNotation(byte[] array){
        String text="";
        char currentChar;
    ...
    public static String printBinaryNotation(byte[] array){
        String text="";
        char currentChar;
        for (int i=0; i<array.length; i++){
            currentChar = (char)array[i];
    ...
    public static void main(String[] args) {
        ...
        writeFile(ENCODED_FILE,printNormalNotation(kood));
        ...
        System.out.println("writing...");
        writeFile(DECODED_FILE,printNormalNotation(orig2));
        System.out.println("reading...");
